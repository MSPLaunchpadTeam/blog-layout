/* blog-article v3.2.0-rc.20 - generated by webflow/build_article_bundle.mjs; edit managed sources, then rebuild. */
(function(){
"use strict";
...
var CP=(function(){
 ...
 function css(p){
  ...
  function layer(size){const t=p.tokens[size];return [
   ...
   rule(root+' a.mspl-btn',t.button),rule(root+' .mspl-cta-arrow',t.arrow),...(t.label?[rule(root+' .mspl-cta-label',{padding:'0',...t.label})]:[]),
   ...
   rule(root+' > p:not(.mspl-offer__button):not(.mspl-btn-line) *',Object.fromEntries(Object.entries(t.body).filter(([k])=>/^(color|font-family|font-size|line-height|letter-spacing|text-)/.test(k))))
  ].join('\n');}
  return [
   root+'{box-sizing:border-box!important;width:100%!important;max-width:100%!important;border:0!important;overflow-wrap:anywhere!important;}',
...
function init() {
  ...
  css.integrity='sha384-a/vRUCCl6RiO6QijVmIRx3lH5NRomBsNYDLaVp+lXSFLIJZ4t0RfN4uduVyPUsKq';css.crossOrigin='anonymous';state.assets.cssIntegrity=css.integrity;
